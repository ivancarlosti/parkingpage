...
replace_placeholder "SUBTEXT" "${SUBTEXT:-Arquitetura e Interiores}"
replace_placeholder "EMAIL" "${EMAIL:-gabriel@gabrielrosarq.com.br}"
replace_placeholder "PHONE" "${PHONE:-+55 11 95061-6188}"
replace_placeholder "WHATSAPP_LINK" "${WHATSAPP_LINK:-https://wa.me/5511950616188}"
